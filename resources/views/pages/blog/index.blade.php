...
<x-layouts.marketing>
    ...
    @volt('blog.index')
        <div class="relative flex flex-col w-full px-6 py-10 mx-auto lg:max-w-6xl sm:max-w-xl md:max-w-full sm:pb-16">
            ...
            <h1 class="text-2xl font-bold tracking-tighter leading-tighter dark:text-white font-heading md:text-3xl">Bem-vindo ao nosso blog</h1>
            <p class="w-full mt-2 text-base font-medium text-neutral-400 dark:text-slate-400 md:mt-2">Sabe mais sobre o que podes fazer no teu carro.</p>
