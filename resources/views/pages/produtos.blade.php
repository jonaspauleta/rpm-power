...
<x-layouts.marketing>
    ...
    <div class="w-full ">
        ...
        <x-ui.marketing.page-header title="Power-Ups"
        ...
        <div class="w-full max-w-6xl px-8 mx-auto">
            ...
            <div
                class="relative w-full p-6 pl-12 text-yellow-700 border border-yellow-200 rounded-lg dark:border-transparent dark:bg-yellow-500 dark:text-white bg-yellow-50">
                <svg class="absolute w-5 h-5 -translate-x-7" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <div class="text-sm opacity-80 dark:opacity-100">Before deploying to production you will want to remove
                    the `pages/genesis` folder. These power-ups should only be installed with a new local app.
                </div>
            </div>

            @if (session()->has('power-up-install'))
                <div
                    class="relative w-full p-6 pl-12 mt-8 text-green-700 border border-green-200 rounded-lg dark:border-transparent dark:bg-green-500 dark:text-white bg-green-50">
                    <svg class="absolute w-5 h-5 -translate-x-7" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div class="text-sm opacity-80 dark:opacity-100">Successfully Installed Power-Up. Please restart
                        your asset watcher to in order to include updated classes and styles.
                    </div>
                </div>
            @endif
            ...
            <div class="grid w-full grid-cols-3 gap-8 mt-8">
                            ...
                            <div
                                ...
                                <span class="flex flex-col justify-start px-1 py-2">
                                        ...
                                        <div class="flex items-center justify-start pb-3">
                                                <span
                                                    class="flex items-center w-auto px-2 py-1 text-xs text-white bg-green-500 rounded-md">
                                                    <svg class="w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none"
                                                         viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path
                        ...
                        <div class="relative space-y-4">
                            ...
                            <div class="flex items-center justify-start space-x-2">
                                ...
                                @if(in_array('pages', $powerup->includes))
                                    <x-ui.badge background="bg-blue-100 dark:bg-blue-600"
                                                color="text-blue-600 dark:text-white">
                                        <svg class="relative w-3.5 h-3.5 mr-1 opacity-90"
                                ...
                                @if(in_array('models', $powerup->includes))
                                    <x-ui.badge background="bg-purple-100 dark:bg-purple-600"
                                ...
                                @if(in_array('migrations', $powerup->includes))
                                    <x-ui.badge background="bg-amber-100 dark:bg-amber-600"
                                                color="text-amber-600 dark:text-white">
                                        <svg class="relative w-3.5 h-3.5 mr-0.5 opacity-90"
                                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                            <path
                            ...
                            <div class="pb-3">
                                <a href="https://github.com/{{ $powerup->repo }}" target="_blank"
                                   class="inline-flex items-center justify-start px-3 py-1.5 space-x-1 text-xs font-normal rounded-full bg-slate-100 dark:text-slate-100 dark:bg-gray-800 text-slate-700">
                                    <svg class="flex w-5 h-5 -ml-1 fill-current" aria-hidden="true" fill="currentColor"
                                         viewBox="0 0 24 24">
                                        <path fill-rule="evenodd"
                            ...
                            <div
                                class="pt-5 prose-sm prose border-t dark:prose-invert border-slate-200 dark:border-gray-800">
                            ...
                            <div
                                class="fixed bottom-0 right-0 z-30 w-full max-w-md p-4 bg-white border-t border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                                <x-ui.button wire:click="install('{{ $powerup->repo }}', '{{ $index }}')" type="success"
                                             rounded="md">
                                        <span class="mr-1.5">
                                            <svg wire:loading class="w-5 h-5 text-white animate-spin"
                                            ...
                                            <svg wire:loading.remove class="w-5 h-5 text-white fill-current"
                                                 viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g
                                                    fill="none" class="signal-icon-wrapper" stroke="none"><path
                                                        d="M18.2502 20.25C19.3548 20.25 20.2502 19.3546 20.2502 18.25L20.2501 9.45157C20.2501 8.99742 20.0955 8.5568 19.8118 8.20217L16.8505 4.50059C16.4709 4.02617 15.8963 3.75 15.2888 3.75L5.75 3.75C4.64543 3.75 3.75 4.64543 3.75 5.75V18.25C3.75 19.3546 4.64543 20.25 5.75 20.25H18.2502Z"
                                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                        stroke-linejoin="round"></path><path
                                                        d="M15.25 8C12.6715 8 11.0903 8 8.75041 8C8.19813 8 7.75 7.55228 7.75 7L7.75 4.25"
                                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                        stroke-linejoin="round"></path><path
                                                        d="M7.75 20.25V14.5C7.75 13.6716 8.42157 13 9.25 13H14.75C15.5784 13 16.25 13.6716 16.25 14.5V20.25"
                                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                ...
                <div
                    class="inline-flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-dashed rounded-md border-gray-200/70 dark:border-slate-700 dark:bg-gray-800/50 dark:text-gray-400">
